...
τον αλγόριθμο Bellman-Ford και από τα αποτελέσματα του να εξάγουμε τα συντομότερα μονοπάτια από 
...
Εδώ βρίσκουμε τις ελάχιστες αποστάσεις για να φτάσουμε σε κάθε κορυφή χρησιμοποιώντας
τους γειτόνους κάθε κορυφής.
...
επαναλήψεις του βρόχου εύρεσης έλαχιστων αποστάσεων δεν πρέπει να μας βρει νέα ελάχιστη απόσταση.
